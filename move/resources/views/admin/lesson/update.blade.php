                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card card-primary">
                            <form method="post" action="{{route('lesson_admin.update', $lesson->lesson_id)}}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{$lesson->number}}" class="form-control"  id="number"
